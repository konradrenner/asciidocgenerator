...
var SideNavigation =
        {
            ...
            expandSideNavigation: function () {
                ...
                if (path == '' || toggler.length == 0) {
                    var links = document.getElementById("sideNavigation").getElementsByTagName('A');
    ...
    applyTocForIE: function () {
        ...
        if (toc !== null) {
            ...
            for (var i = 0; i < tocLinks.length; i++) {
                var link = tocLinks[i];
                var originHref = link.getAttribute("href");
                link.setAttribute("href", window.location.pathname + originHref);
            }
        }
    }
}
